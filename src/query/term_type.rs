// FIXME: generate this from ql2.proto
...
pub const SUB: TermType = 25;
pub const MUL: TermType = 26;
pub const DIV: TermType = 27;
pub const MOD: TermType = 28;
